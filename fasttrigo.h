...
#ifdef QT_GUI_LIB
	double length(QVector2D vector); //cartesian vector(x,y)
	double length(QVector3D vector); //cartesian vector(x,y,z)
	double angle(QVector2D vector); //cartesian vector(x,y)
	double azimuth(QVector3D vector); //cartesian vector(x,y,z)
	double inclination(QVector3D vector); //cartesian vector(x,y,z)
	double x(QVector2D vector); //polar vector(length,angle)
	double y(QVector2D vector); //polar vector(length,angle)
	double x(QVector3D vector); //spherical vector(length,azimuth,inclination)
	double y(QVector3D vector); //spherical vector(length,azimuth,inclination)
	double z(QVector3D vector); //spherical vector(length,azimuth,inclination)
